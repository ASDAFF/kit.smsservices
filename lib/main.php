...
class Main {
	...
	public function getKitRowListAdmin($arRes){
		...
		$this->getKitRowListAdminCustomRow($row);
				...
				<?foreach($val as $field){
					...
					if($type=="INT"){
						...
						if(is_array($field["VALUES"])){
							...
							$values = array(
								"reference" => array(
									Loc::getMessage("KIT_ADMIN_LIST_SELECT_Y"),
									Loc::getMessage("KIT_ADMIN_LIST_SELECT_N"),
								),
								"reference_id" => array(
									"Y",
									"N",
						...
						?>
						<?echo SelectBoxFromArray($row, $values, ${$row}, Loc::getMessage("KIT_ADMIN_LIST_SELECT_EMPTY"), "");?>
						<?
					}elseif($type=="LIST"){
						$values = array();
						if(is_array($field["VALUES"])){

...
class Handlers {
	...
	{
		$active = \COption::GetOptionString('kit.smsservices', 'activesale', "N");
		...
		if($active!="N"){
			...
			$phoneFieldCode = \COption::GetOptionString('kit.smsservices', "property_phone_".$arParameters["LID"].'_'.$arParameters["PERSON_TYPE_ID"], "");
			
			$adminPhone = \COption::GetOptionString('kit.smsservices', "admin_phone_".$arParameters["LID"].'_'.$arParameters["PERSON_TYPE_ID"], "");
			...
			if(strlen($phoneFieldCode)>0) {
				...
				$userMess = \COption::GetOptionString('kit.smsservices', "mess_status_".$arParameters["LID"]."_new_".$arParameters["PERSON_TYPE_ID"], "");
				...
				$adminMess = \COption::GetOptionString('kit.smsservices', "mess_status_".$arParameters["LID"]."_new2_".$arParameters["PERSON_TYPE_ID"], "");
				...
				//$adminMess = COption::GetOptionString('kit.smsservices', 'adminmess_status_'.$arOrderFields['LID']);
				//$adminMess = str_replace(array_keys($arMakros), $arMakros, $adminMess);
				
				//отправка смс пользователю
				if($userMess){
					$obSmsServ = new \Kit\Smsservices\Sender();
	...
	public static function OnSaleStatusOrderHandler($orderId,$statusid)
	{
		...
		if($active!="N"){
			...
			if(strlen($phoneFieldCode)>0) {
				...
				$userMess = \COption::GetOptionString('kit.smsservices', "mess_status_".$arParameters["LID"]."_".$statusid."_".$arParameters["PERSON_TYPE_ID"], "");
				if(strlen($userMess)>0) {
					$userMess = str_replace(array_keys($arMakros), $arMakros, $userMess);
				}else{
					$userMess = false;
	...
	public static function OnSaleCancelOrderHandler($orderId,$flag)
	{
		...
		if($active!="N"){
			...
			if(strlen($phoneFieldCode)>0) {
				...
				$userMess = \COption::GetOptionString('kit.smsservices', "mess_status_".$arParameters["LID"]."_cancel".$flag."_".$arParameters["PERSON_TYPE_ID"], "");
				if(strlen($userMess)>0) {
					$userMess = str_replace(array_keys($arMakros), $arMakros, $userMess);
				}else{
					$userMess = false;
	...
	public static function OnSaleDeliveryOrderHandler($orderId,$flag)
	{
		...
		if($active!="N"){
			...
			if(strlen($phoneFieldCode)>0) {
				...
				$userMess = \COption::GetOptionString('kit.smsservices', "mess_status_".$arParameters["LID"]."_delivery".$flag."_".$arParameters["PERSON_TYPE_ID"], "");
				if(strlen($userMess)>0) {
					$userMess = str_replace(array_keys($arMakros), $arMakros, $userMess);
				}else{
					$userMess = false;
	...
	public static function OnSalePayOrderHandler($orderId,$flag)
	{
		...
		if($active!="N"){
			...
			if(strlen($phoneFieldCode)>0) {
				...
				$userMess = \COption::GetOptionString('kit.smsservices', "mess_status_".$arParameters["LID"]."_pay".$flag."_".$arParameters["PERSON_TYPE_ID"], "");
				if(strlen($userMess)>0) {
					$userMess = str_replace(array_keys($arMakros), $arMakros, $userMess);
				}else{
					$userMess = false;

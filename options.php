...
$APPLICATION->SetTitle(Loc::getMessage("KITSS_OPT_TITLE"));
...
$bollModuleSale = \Bitrix\Main\Loader::includeModule("sale");
	...
	if($bollModuleSale) {
		...
		while($arProperty = $db_props->Fetch()) {
			...
			$arMakros[$arProperty["PERSON_TYPE_ID"]]['USER_PHONE'] = Loc::getMessage("KITSS_IM_MACROS1");
			$arMakros[$arProperty["PERSON_TYPE_ID"]]['ORDER_NUM'] = Loc::getMessage("KITSS_IM_MACROS2");
			$arMakros[$arProperty["PERSON_TYPE_ID"]]['ORDER_PRICE'] = Loc::getMessage("KITSS_IM_MACROS3");
			$arMakros[$arProperty["PERSON_TYPE_ID"]]['DELIVERY_PRICE'] = Loc::getMessage("KITSS_IM_MACROS4");
			$arMakros[$arProperty["PERSON_TYPE_ID"]]['STATUS_NAME'] = Loc::getMessage("KITSS_IM_MACROS5");
			$arMakros[$arProperty["PERSON_TYPE_ID"]]['DELIVERY_NAME'] = Loc::getMessage("KITSS_IM_MACROS6");
			$arMakros[$arProperty["PERSON_TYPE_ID"]]['ORDER_SUM'] = Loc::getMessage("KITSS_IM_MACROS7");
		}
...
$aTabs = array();
$aTabs[] = array("DIV" => "edit3", "TAB" => Loc::getMessage("KITSS_OPT_TAB1"), "ICON" => "vote_settings", "TITLE" => Loc::getMessage("KITSS_OPT_TAB1_T"));
...
$aTabs[] = array("DIV" => "edit4", "TAB" => Loc::getMessage("KITSS_OPT_TAB2"), "ICON" => "vote_settings2", "TITLE" => Loc::getMessage("KITSS_OPT_TAB2_T"));
...
?>
	<tr class="heading"><td colspan="2"><?=Loc::getMessage("KITSS_OPT_SHLUZ_MAIN_SHARE")?><a href="http://kit-media.by/tpages/kod-na-500-sms.php?utm_source=kit_smsservices&utm_medium=bxadmin&utm_term=domain&utm_content=<?=$_SERVER['HTTP_HOST']?>&utm_campaign=smsasistent" target="_blank"><?=Loc::getMessage("KITSS_OPT_SHLUZ_MAIN_SHARE_2")?></a> | <a href="http://sms-assistent.by/rekvizity/" target="_blank"><?=Loc::getMessage("KITSS_OPT_SHLUZ_MAIN_SHARE_3")?></a></td></tr>
	<tr class="heading"><td colspan="2"><?=Loc::getMessage("KITSS_OPT_SHLUZ_MAIN")?></td></tr>
	<tr>
		<td><?=Loc::getMessage("KITSS_OPT_SHLUZ")?>:</td>
		<td>
			...
			$smslist = glob($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/kit.smsservices/lib/transport/*.php");
			foreach ($smslist as $value) {
				
				$name = str_replace($_SERVER["DOCUMENT_ROOT"].'/bitrix/modules/kit.smsservices/lib/transport/','',$value);
	...
	<tr>
		<td><?=Loc::getMessage("KITSS_OPT_OTPLIST")?>:</td>
		<td>
	...
	<tr>
		<td><?=Loc::getMessage("KITSS_OPT_OTPCACHE")?>:</td>
		<td>
	...
	<tr>
		<td><?=Loc::getMessage("KITSS_OPT_BALANCECACHE")?>:</td>
		<td>
	...
	<tr class="heading"><td colspan="2"><?=Loc::getMessage("KITSS_OPT_SHLUZ_RESERVE")?></td></tr>
	<tr>
		<td><?=Loc::getMessage("KITSS_OPT_SHLUZ")?>:</td>
		<td>
	...
	<tr class="heading"><td colspan="2"><?=Loc::getMessage("KITSS_OPT_SHLUZ_APP")?></td></tr>
	<tr>
		<td><?=Loc::getMessage("KITSS_OPT_SHLUZ")?>:</td>
		<td>
	...
	<tr class="heading"><td colspan="2"><?=Loc::getMessage("KITSS_OPT_TITLEDOP")?></td></tr>
	<?
	if($bollModuleSale){
	?>
	<tr>
		<td><?=Loc::getMessage("KITSS_IM_ON")?>:</td>
		<td>
	...
	<tr>
		<td><?=Loc::getMessage("KITSS_OPT_TRANSLIT")?>:</td>
		<td>
...
foreach($arSites as $siteId=>$siteName){
	...
	?>
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_PHONE")?> <?=$persName?>:</td>
		<td>
			<?$val = \Bitrix\Main\Config\Option::get($module_id, "property_phone_".$siteId."_".$persid, "","");?>
			<?echo \CKitSmsServicesHtml::getSelect("property_phone_".$siteId."_".$persid,$arOrderProps[$persid],$val,false,false,true);?>
		</td>
	</tr>
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_PHONEADMIN")?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
	...
	<tr>
		<td><?=Loc::getMessage("KITSS_IM_PROP_MACROS")?>:</td>
		<td>
	...
	?>
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS")?> <?=$statusname[LANGUAGE_ID]?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
	...
	?>
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS_OTMY")?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
	...
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS_OTMN")?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
	...
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS_DOSTY")?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
	...
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS_DOSTN")?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
	...
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS_OPLY")?> <?=$persName?>:</td>
		<td>
	...
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS_OPLN")?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
	...
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS_NEW")?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
	...
	<tr>
		<td style="width:50%;"><?=Loc::getMessage("KITSS_IM_PROP_STATUS_NEWADMIN")?>, <?=Loc::getMessage("KITSS_IM_PROP_DLYA")?> <?=$persName?>:</td>
		<td>
...
$tabControl->Buttons();
?>
	<input <?if ($MODULE_RIGHT<"W") echo "disabled" ?> type="submit" class="adm-btn-green" name="Update" value="<?=Loc::getMessage("KITSS_OPT_SEND")?>" />
